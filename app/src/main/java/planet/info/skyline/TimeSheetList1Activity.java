...
public class TimeSheetList1Activity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    public void getTimesheetList() {
        ...
        final String SOAP_ACTION = KEY_NAMESPACE + "GetFutureTimeEntry";
        final String METHOD_NAME = "GetFutureTimeEntry";
...
//            Timesheet clientUser = list_TimeSheet.get(position);
    ...
    public String Submit_ChangeTimeCode() {

        String receivedString = "";
        final String NAMESPACE = KEY_NAMESPACE;
        final String URL = URL_EP2 + "/WebService/techlogin_service.asmx?";
        final String SOAP_ACTION = KEY_NAMESPACE + Utility.Method_CHANGE_TIME_CODE_TIMESHEET;
        final String METHOD_NAME = Utility.Method_CHANGE_TIME_CODE_TIMESHEET;
        SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);
        ...
        request.addProperty("start_time", str_startTime);
        request.addProperty("end_time", str_startTime);
        request.addProperty("description", description);
        request.addProperty("code", code);
