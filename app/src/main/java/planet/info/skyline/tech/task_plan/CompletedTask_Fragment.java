                    ...
                    public void onNext(List<TaskPlan> taskPlan) {
                        if (taskPlan != null && !taskPlan.isEmpty()) {
                            for (TaskPlan taskPlan1 : taskPlan) {
                                if (taskPlan1.getIsGreen().equals("1")) {
...
/*    private void setTempData(){
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 1", "Dept SWO - Task 1", "3/3", "01/1/2019", "06/14/2019", "30 min", "06/14/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 2", "Dept SWO - Task 2", "3/3", "05/21/2019", "02/08/2019", "30 min", "12/21/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 3", "Dept SWO - Task 3", "3/3", "07/14/2019", "01/05/2019", "30 min", "11/05/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 4", "Dept SWO - Task 4", "3/3", "08/05/2019", "11/11/2019", "30 min", "06/04/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 5", "Dept SWO - Task 5", "3/3", "08/02/2019", "02/14/2019", "30 min", "08/21/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 5", "Dept SWO - Task 5", "3/3", "11/08/2019", "04/25/2019", "30 min", "08/31/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 6", "Dept SWO - Task 6", "3/3", "12/09/2019", "05/11/2019", "30 min", "04/06/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 7", "Dept SWO - Task 7", "3/3", "05/04/2019", "02/12/2019", "30 min", "07/15/2019", "tech tech","test user"));
        list_TaskPlan.add(new TaskPlan("Dept SWO - Task 8", "Dept SWO - Task 8", "3/3", "01/17/2019", "03/21/2019", "30 min", "06/22/2019", "tech tech","test user"));
    ...
    public class JobFilesAdapter extends RecyclerView.Adapter<JobFilesAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.row_complete_task_1, parent, false);
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int i) {
            ...
            holder.view1.setBackgroundColor(getResources().getColor(R.color.green_material2));
            ...
            if (completedDate == null || completedDate.trim().equals("")) {
                holder.Completed_date.setText("Not available");
            } else {
                holder.Completed_date.setText(Utility.ChangeDateFormat("yyyy-MM-dd", "dd MMM yyyy", completedDate.trim()));
            }


            if (technician == null || technician.trim().equals("")) {
                holder.Technician.setText("Not available");
            } else {
                holder.Technician.setText(technician);
            }
            ...
            if (completedBy == null || completedBy.trim().equals("")) {
                holder.Completed_By.setText("Not available");
            } else {
                holder.Completed_By.setText(completedBy);
            }
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            TextView Task, Description, Checklist, deadline_date, Time_Budget, Start_By, Completed_By;
            TextView Technician, Completed_date;
            Button index_no;
            ...
            public MyViewHolder(View convertview) {
                ...
                Technician = (TextView) convertview.findViewById(R.id.Technician);
                Completed_date = (TextView) convertview.findViewById(R.id.Completed_date);
                Completed_By = (TextView) convertview.findViewById(R.id.Completed_By);
