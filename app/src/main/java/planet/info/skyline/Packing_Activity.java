  ...
  //  JsonParser jsonParser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      Utils1.setListViewHeightBasedOnChildren(Exbit_graphic_list); //issue in this
        ...
        Picasso.with(Packing_Activity.this).load(URL_EP1+"/admin/uploads/collateral/1462793388_exhibit3__511.jpg").into(img);
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Picasso.with(Packing_Activity.this).load(URL_EP1+"/admin/uploads/collateral/1462793388_exhibit3__511.jpg").into(image);
                d.show();
    ...
    ///for fetch the Client name from the server-
    ...
    public  class Collateral_Adapter  extends BaseAdapter
    {
        ...
        public View getView(final int i, View convertview, ViewGroup viewGroup) {
            ...
            Picasso.with(Packing_Activity.this).load(URL_EP1+"/admin/uploads/collateral/1462793388_exhibit3__511.jpg").into(holder.Image);
