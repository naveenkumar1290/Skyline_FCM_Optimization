...
public class Allmissingcreates extends BaseActivity {
	...
	String linkforallcreate =URL_EP1+"/crate_web_service.php?id=1368";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (fromact.equalsIgnoreCase("home")) {
			linkforallcreate =URL_EP1+"/location_web_service.php?id="
					+ sggs;
		} else {
			linkforallcreate =URL_EP1+"/location_web_service_location.php?LocationId="
					+ locationcreate;
		}
		// bimm=bimm+"# E01010";
