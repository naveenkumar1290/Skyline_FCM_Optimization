...
//                    job_Name_list_Desc.add(total_desc);
    ...
    public void dialog_select_job()    /////by aman kaushik
    {
        ...
        final Dialog dialog_companyName = new Dialog(Proof_RendersActivity.this);
        ...
        CompanyNameAdapter jobDescAdapter = new CompanyNameAdapter(Proof_RendersActivity.this, android.R.layout.simple_list_item_1, job_Name_list_Desc);
        ...
        btn_GO.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!job_Name_list.contains(autocomplete_job_name.getText().toString().trim())) {
                    Toast.makeText(Proof_RendersActivity.this, "Kindly enter a valid job name!", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        dialog_companyName.dismiss();
                    } catch (Exception e) {
    ...
    public void showJobSearchDialogNew(String dialog_title, final Context context) {
        ...
        LayoutInflater inflater = Proof_RendersActivity.this.getLayoutInflater();
...
//
    ...
    private class get_company_job_id extends AsyncTask<String, Void, Void> {
        ...
        final ProgressDialog ringProgressDialog = new ProgressDialog(Proof_RendersActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            // dialog_select_job();
            showJobSearchDialogNew("Job(s)", Proof_RendersActivity.this);
