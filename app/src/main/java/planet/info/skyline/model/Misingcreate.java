...
public class Misingcreate {
	...
	public Misingcreate(String crname, String descStringname, String locaStringcraename, int pos, String found_miss, int missim , int selectim, String unique_crate_idm)
	{
